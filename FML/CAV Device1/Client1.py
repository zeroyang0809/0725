...
def main():
    ...
    try:
        ...
        print('Connection start: ', Connectstart)
        ...
        input('Client1 Ready?  (y/n)\n')

        Connectend = time.time()
        print('Connection End: ', Connectend)
        ...
        for epoch in range(num_epochs):
            ...
            while recv_param == None:
                print('Client1 is waiting for parameter')
                time.sleep(0.5)
        ...
        print(f'Training Success!! Total {args.epoch} epoch')
...
if __name__ == '__main__':
   ...
   Reg_addr = "client1_" + str( random.randint(1,1000 )) #if None, Reg_addr = MAC address
   DAN.profile['dm_name']='client1'   # you can change this but should also add the DM in server
