    ...
    try:
        ...
        for epoch in range(num_epochs):
            ...
            while recv_param == None:
                print('Client2 is waiting for parameter')
                time.sleep(0.5)
            ...
            # convert to tolist type otherwise it can not be transmitted by IoTtalk
            training_loss = training_loss.detach().numpy().tolist()
...
if __name__ == '__main__':
   ...
   Reg_addr = "Client2_" + str( random.randint(1,1000 )) #if None, Reg_addr = MAC address
   DAN.profile['dm_name']='client2'   # you can change this but should also add the DM in server
